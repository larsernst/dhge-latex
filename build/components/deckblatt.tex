...
{
    \ifnum#1 = 1
        \def\checkboxes{#2 {{$\boxtimes$}} #2 {$\square$} #2 {$\square$}}
    \else\ifnum#1 = 2
        \def\checkboxes{#2 {$\square$} #2 {{$\boxtimes$}} #2 {$\square$}}
    \else\ifnum#1 = 3
        \def\checkboxes{#2 {$\square$} #2 {$\square$} #2 {{$\boxtimes$}}}
    \else
        \def\checkboxes{#2 {$\square$} #2 {$\square$} #2 {$\square$}}
    \fi\fi\fi\fi
