...
% 1 verwendet das Glossar (Fachbegriffe + Abkürzungen, Einträge in glossar.tex,
%   erscheint hinter den Anhängen, vor dem Literaturverzeichnis)
% 0 verwendet das klassische Abkürzungsverzeichnis (acro-Paket, Einträge in
%   abk.tex, erscheint vor dem Hauptteil hinter dem Tabellenverzeichnis)
% Hinweis: Im Kusche-Mode (CKUSCHE=1) wird das Glossar empfohlen
\def\CGLOSSAR       {1}
...
% 1 lädt das minted-Paket (Syntax-Highlighting für Code-Umgebungen)
% Hinweis: benötigt auf dem Build-System das Python-Backend "latexminted"
% (auf der eigenen Overleaf-Instanz via fix-texlive.sh installiert)
\def\CMINTED        {0}

% 1 lädt das todonotes-Paket (Randnotizen mit \todo{...})
% Hinweis: setzt \marginparwidth auf 2cm, damit Notizen in die schmalen
% DHGE-Ränder passen
\def\CTODONOTES     {0}
